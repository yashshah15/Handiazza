...
{  
    ...
    JButton b1,b2;  
    ButtonGroup bg;  
    static int count,current=0,x=1,y=1,now=0;  
    int m[]=new int[10];      
    OnlineTest(String s)  
    {  
        super(s);  
    ...
    {  
        ...
        if(current==6)  
        {  
            l.setText("Que7: which of the following is access specifiers? ");  
            jb[0].setText("Swing");jb[1].setText("private");jb[2].setText("ActionEvent");  
                        jb[3].setText("Button");  
        }  
        if(current==7)  
        {  
    ...
    {  
        ...
        Class.forName("com.mysql.jdbc.Driver");
                ...
                PreparedStatement ps = c.prepareStatement("insert into tbl2 values(?)");
                ps.setInt(1,count);
                ps.executeUpdate();
    }  
}  
