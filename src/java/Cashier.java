...
class Menu extends JFrame implements KeyListener {
    ...
    private final JPanel menuNorthPanel;
    private final JPanel menuSouthPanel;
    private final JPanel menuCenterPanel;
    private final JPanel menuTitlePanel;
    private final JPanel menuDetailPanel;
	private JPanel menuChoicePanel,
				   menuHeadrPanel;
	 ...
	 */
	public static String choice[] = {"Fried Rice     ",
								   	"Noodles        ",
					   				"Paneer chilli  ",
					   				"Mix veg        ",
					   				"Sandwiches     ",
	...
	public Menu() {
		...
		menuStoreLabel = new JLabel(" ANGEL Restaurant ");
		...
		menuGuideLabel = new JLabel("   Use the keyboard and press the appropriate keys");
...
class SubTotal extends JFrame implements KeyListener {
	 ...
	 * This constructor initialize GUI components
	 */
	public SubTotal() throws SQLException, ClassNotFoundException {
		...
		subTotalStoreLabel = new JLabel(" ANGEL Restaurant ");
		...
		subTotalGrandTotalLabel = new JLabel(" Sub Total : RS " + grandTotal + "0");
		...
		subTotalOrderedPanel.setLayout(new GridLayout(count+2,1,0,0));
                ...
                PreparedStatement ps = c.prepareStatement("insert into tbl1 values(?)");
