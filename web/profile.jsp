...
<html>
    ...
    <body id="page-top">
        ...
        <%
            ...
            PreparedStatement ps = c.prepareStatement("Select * from personal_details where sap_id=?");
            ps.setString(1, s);
            ResultSet rs;
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="eprofile (1).jsp">Revise</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="experience">
                <div class="my-auto">
                    ...
                    <%
                        long se = Long.parseLong(session.getAttribute("user").toString());
            ...
            <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
                <div class="my-auto">
                    ...
                    <table>
                        <%
                            se = Long.parseLong(session.getAttribute("user").toString());
